...
At QCS 2+, detect project type per [rules/PROJECT_DETECTION.md](rules/PROJECT_DETECTION.md). Load the matching `COMMANDS.[type].md`. Do NOT load COMMANDS files for other project types.
...
All 6 gates are **hard-enforced**. See [rules/GATES.md](rules/GATES.md) for full specifications.
...
**Response examples:** See [rules/EXAMPLES.md](rules/EXAMPLES.md) for 6 complete response examples showing all gates.
...
| Context Discipline | Follow [CONTEXT.md](rules/CONTEXT.md) for subagent management, tool selection, and output routing. |
...
-> **Full mode details:** See [rules/MODES.md](rules/MODES.md)
...
> Loaded conditionally when `pubspec.yaml` detected. See [rules/COMMANDS.flutter.md](rules/COMMANDS.flutter.md).

-> **Full command list:** See [rules/COMMANDS.md](rules/COMMANDS.md)
...
-> **Full command list:** See [rules/COMMANDS.md](rules/COMMANDS.md#slash-commands)
...
| Topic | File |
|-------|------|
| **Mode workflows** | [rules/MODES.md](rules/MODES.md) |
| **Gate specifications** | [rules/GATES.md](rules/GATES.md) |
| **Protocol Lite** | [rules/PROTOCOL_LITE.md](rules/PROTOCOL_LITE.md) *(QCS 0-1 only, self-contained)* |
| **Session Management** | [rules/SESSION.md](rules/SESSION.md) |
| **Code Comment Tags** | [rules/CODE_COMMENTS.md](rules/CODE_COMMENTS.md) |
| **Project Commands** | [rules/COMMANDS.md](rules/COMMANDS.md) |
| **Coding Styles (Universal)** | [rules/STYLES.md](rules/STYLES.md) |
| **Code Examples** | [rules/EXAMPLES.md](rules/EXAMPLES.md) |
| **Visual Context** | [rules/VISUAL.md](rules/VISUAL.md) |
| **Recovery Protocol** | [rules/SESSION.md](rules/SESSION.md) |
| **Self-Improvement** | LEARN-PERSIST in [rules/GATES.md](rules/GATES.md) + `tmp/learn-persist.md` |
| **Explain Command** | [rules/EXPLAIN.md](rules/EXPLAIN.md) *(lazy-load: only read when `/explain` invoked)* |
| **Protocol Changelog** | [rules/PROTOCOL_CHANGELOG.md](rules/PROTOCOL_CHANGELOG.md) *(lazy-load: only read when /improve-protocol invoked or user explicitly asks about protocol version history)* |

| **Project Detection** | [rules/PROJECT_DETECTION.md](rules/PROJECT_DETECTION.md) |
| **Skills System** | [rules/SKILLS.md](rules/SKILLS.md) |
| **Architecture Overview** | [rules/ARCHITECTURE.md](rules/ARCHITECTURE.md) |
| **Context Management** | [rules/CONTEXT.md](rules/CONTEXT.md) |
| **Flutter Commands** | [rules/COMMANDS.flutter.md](rules/COMMANDS.flutter.md) *(conditional: loaded for Flutter/Dart projects with pubspec.yaml)* |
| **Node.js Commands** | [rules/COMMANDS.node.md](rules/COMMANDS.node.md) *(conditional: loaded for Node.js projects with package.json)* |
| **Python Commands** | [rules/COMMANDS.python.md](rules/COMMANDS.python.md) *(conditional: loaded for Python projects with pyproject.toml/setup.py/requirements.txt)* |
| **React/TS Styles** | [rules/STYLES.react.md](rules/STYLES.react.md) *(conditional: loaded for Node.js/React projects with package.json)* |
| **Protocol Testing** | [rules/SIMULATION_PLAN.md](rules/SIMULATION_PLAN.md) *(lazy-load: only read when `/simulate` invoked)* |
